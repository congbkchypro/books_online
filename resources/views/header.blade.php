			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="#"><i class="fa fa-home"></i> 90-92 Ta Quang Buu, Hai Ba Trung, Ha Noi</a></li>
						<li><a href="#"><i class="fa fa-phone"></i> 0165 9086 091</a></li>
					</ul>
				</div>
  ...
  <div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					...
					<h2 style="color: red; height: 75px">BOOK ONLINE</h2>
				</div>
